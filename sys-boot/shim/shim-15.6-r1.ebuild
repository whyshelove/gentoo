...
pkg_setup() {
	...
	S2="${WORKDIR}/redhatsecurebootca5.cer"
	S1="${WORKDIR}/redhatsecureboot501.cer"
}
...
distrosign() {
	...
	_pesign ${1}${efi_arch}-unsigned.efi ${1}${efi_arch}-signed.efi "${S2}" "${S1}" redhatsecureboot501 || die
