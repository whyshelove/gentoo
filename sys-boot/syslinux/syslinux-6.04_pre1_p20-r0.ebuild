...
DPREFIX="$(ver_cut 6)."
inherit toolchain-funcs flag-o-matic secureboot rhel9
...
src_prepare() {
	local PATCHES=(
		"${FILESDIR}/${PV%_p*}/0001-Strip-the-.note.gnu.property-section-for-the-mbr.patch"
		"${FILESDIR}/${PV%_p*}/0002-Force-the-linker-to-put-all-sections-into-a-single-P.patch"
		"${FILESDIR}/${PV%_p*}/0004-Inherit-toolchain-vars-from-environment.patch"
	)
