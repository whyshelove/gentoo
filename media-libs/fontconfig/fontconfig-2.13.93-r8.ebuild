...
inherit autotools multilib-minimal readme.gentoo-r1 rhel9-a
...
multilib_src_configure() {
	...
	case ${CHOST} in
		...
		*-linux-gnu)
			use prefix && [[ -d /usr/share/fonts ]] && \
				addfonts=",/usr/share/fonts,/usr/share/X11/fonts/Type1,/usr/share/X11/fonts/TTF"
		;;
	esac
	...
	local myeconfargs=(
		...
		--enable-libxml2
		--with-cache-dir="${EPREFIX}"/usr/lib/fontconfig/cache
	)
