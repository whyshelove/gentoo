...
multilib_src_configure() {
	...
	append-cxxflags -Wno-address -Wno-nonnull -Wno-maybe-uninitialized
	append-cflags -Wno-address -Wno-nonnull -Wno-maybe-uninitialized
	...
	if multilib_is_native_abi; then
		...
		mycmakeargs+=(
			-DLLVM_EXTERNAL_CLANG_TOOLS_EXTRA_SOURCE_DIR="${WORKDIR}"/clang-tools-extra-${PV}.src
