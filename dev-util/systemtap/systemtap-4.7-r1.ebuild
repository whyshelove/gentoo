...
inherit autotools linux-info python-single-r1 rhel8-a
...
DEPEND="
	...
	debuginfod? ( dev-libs/elfutils[debuginfod] )
	crash? (
		dev-util/crash
		sys-libs/zlib
	)
...
src_configure() {
	local myeconfargs=(
		...
		$(use_with debuginfod)
		$(use_with crash)
		$(use_with py3probes python3-probes)
		$(use_with bpf)	
		--disable-docs
		--disable-grapher
		--disable-refdocs
	...
	if use dracut; then
		dracutstap="${_prefix}/lib/dracut/modules.d/99stap"
