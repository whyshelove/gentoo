...
inherit bash-completion-r1 flag-o-matic linux-info meson-multilib pam python-any-r1 systemd toolchain-funcs udev usr-ldscript rhel9
...
#        	-Drc-local=/etc/rc.d/rc.local
		...
		-Dblkid=true
		-Dsmack=true
		-Dcryptolib=$(usex openssl openssl auto)
		-Dgnutls=true
		-Defi=true
...
multilib_src_install_all() {
	...
	keepdir /var/log/journal /var/log/private
