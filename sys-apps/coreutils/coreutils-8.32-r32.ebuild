...
src_configure() {
	...
	append-cflags -fno-strict-aliasing -fpic -Dlint
...
src_install() {
	cp ${WORKDIR}/supported_utils .
	default

	exeinto ${_sysconfdir}/profile.d/
	newexe "${WORKDIR}"/coreutils-colorls.sh colorls.sh
	newexe "${WORKDIR}"/coreutils-colorls.csh colorls.csh

	insinto /etc
	#newins src/dircolors.hin DIR_COLORS
	doins -r DIR_COLORS{,.lightbgcolor}
