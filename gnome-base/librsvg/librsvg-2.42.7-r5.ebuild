...
inherit autotools gnome2 multilib-minimal vala rhel8-a
...
LICENSE="LGPL-2+"
SLOT="2"
KEYWORDS="~alpha arm hppa ~amd64 ~mips ppc ~s390 sparc x86 ~amd64-linux ~x86-linux ~x64-macos ~sparc-solaris ~x64-solaris ~x86-solaris"
