...
SRC_URI="${BaseOS}/centos-stream-release-9.0-1.0.4.el9.noarch.rpm"

for macro in cmake-rpm-macros-3.20.2-2 efi-srpm-macros-4-7 perl-srpm-macros-1-40 redhat-rpm-config-185-3 \
	python-qt5-rpm-macros-5.15.0-9 python-rpm-macros-3.9-38 python-srpm-macros-3.9-38 python3-rpm-macros-3.9-38 \
