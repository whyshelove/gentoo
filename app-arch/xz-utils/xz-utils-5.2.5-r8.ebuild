...
multilib_src_configure() {
	...
	sed -i 's|^hardcode_libdir_flag_spec=.*|hardcode_libdir_flag_spec=""|g' libtool || die
	sed -i 's|^runpath_var=LD_RUN_PATH|runpath_var=DIE_RPATH_DIE|g' libtool || die
}
...
multilib_src_install_all() {
	...
	doins "${WORKDIR}"/colorxzgrep.{c,}sh
}
