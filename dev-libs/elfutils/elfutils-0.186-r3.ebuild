...
inherit flag-o-matic multilib-minimal rhel9
...
multilib_src_install_all() {
	...
	insinto ${_unitdir}/
	doins config/debuginfod.service

	insinto ${_sysconfdir}/sysconfig/
	newins config/debuginfod.sysconfig debuginfod

	dodir ${_localstatedir}/cache/debuginfod
	touch "${ED}"${_localstatedir}/cache/debuginfod/debuginfod.sqlite
}
