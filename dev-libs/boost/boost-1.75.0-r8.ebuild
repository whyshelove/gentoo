...
inherit flag-o-matic multiprocessing python-r1 toolchain-funcs multilib-minimal rhel9-a
	...
	if python_bindings_needed; then
		...
		append_to_user_config() {
			...
			if tc-is-cross-compiler; then
				py_config="using python : ${EPYTHON#python} : : ${ESYSROOT}/usr/include/${EPYTHON} : ${ESYSROOT}/usr/$(get_libdir) : ${ESYSROOT}/usr/include/${EPYTHON}${PYTHON3_ABIFLAGS} : : : ;"
			else
				py_config="using python : ${EPYTHON#python} : ${PYTHON} : $(python_get_includedir) : ${ESYSROOT}/usr/include/${EPYTHON}${PYTHON3_ABIFLAGS} : : : ;"
			fi
