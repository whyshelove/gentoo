...
multilib_src_configure() {
	...
	myconf+=(
		...
		--with-krb5-rcache-dir=${EPREFIX}/var/cache/krb5rcache
		--enable-nsslibdir="${EPREFIX}"/usr/$(get_libdir)
		--enable-nfsidmaplibdir="${EPREFIX}"/usr/libnfsidmap
...
#	insinto ${_sysconfdir}/rwtab.d
#	newins src/examples/rwtab sssd

#	dodir ${_sysconfdir}/krb5.conf.d
#	doins ${ED}${_datadir}/sssd-kcm/kcm_default_ccache
