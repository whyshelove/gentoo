...
src_configure() {
	...
	append-cflags -D_GNU_SOURCE -fPIC -fwrapv
	export CFLAGS_NODIST="$CFLAGS -D_GNU_SOURCE -fPIC -fwrapv"
	append-cxxflags -D_GNU_SOURCE -fPIC -fwrapv
	...
	local myeconfargs=(
		...
		--with-computed-gotos
		--with-dbmliborder="${dbmliborder}:ndbm:bdb"
		--with-libc=
		--enable-loadable-sqlite-extensions
		--without-ensurepip
		--with-system-expat
		--with-system-ffi
		--with-platlibdir="${EPREFIX}"/usr/lib
		--with-lto
