...
inherit autotools flag-o-matic multiprocessing pax-utils \
	python-utils-r1 toolchain-funcs rhel8-a

MY_PV=${PV/_rc/rc}
MY_P="Python-${MY_PV%_p*}"
PYVER=$(ver_cut 1-2)
PATCHSET="python-gentoo-patches-${MY_PV%_p*}_p1"
...
src_unpack() {
	rpm_src_unpack ${A}
	mv ${WORKDIR}/{"00001-rpath.patch","00102-lib64.patch","00111-no-static-lib.patch" \
	,"00359-CVE-2021-23336.patch","00189-use-rpm-wheels.patch"} ${WORKDIR}/${PATCHSET}/
}
