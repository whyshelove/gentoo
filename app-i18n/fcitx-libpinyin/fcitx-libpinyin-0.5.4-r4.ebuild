...
if [[ "${PV}" =~ (^|\.)9999$ ]]; then
	...
	SRC_URI="https://download-ib01.fedoraproject.org/pub/fedora/linux/releases/37/Everything/source/tree/Packages/f/fcitx-libpinyin-0.5.4-4.fc37.src.rpm"
fi
