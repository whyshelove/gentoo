...
inherit autotools flag-o-matic lua-single systemd toolchain-funcs tmpfiles rhel8-a
...
src_install() {
	...
	insinto ${_sysconfdir}/systemd/system/${PN}.service.d
	newins "${WORKDIR}"/redis-limit-systemd limit.conf
	insinto ${_sysconfdir}/systemd/system/${PN}-sentinel.service.d
	newins "${WORKDIR}"/redis-limit-systemd limit.conf

#	exeinto ${_libexecdir}
#	doexe "${WORKDIR}"/${PN}-shutdown
