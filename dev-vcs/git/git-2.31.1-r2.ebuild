...
inherit toolchain-funcs elisp-common perl-module bash-completion-r1 plocale python-single-r1 systemd rhel-a
...
PATCHES=(
	...
	${WORKDIR}/git-2.27.0-core-crypto-hmac.patch
	${WORKDIR}/git-cvsimport-Ignore-cvsps-2.2b1-Branches-output.patch
)
...
src_prepare() {
	...
	install -p -m 755 ${WORKDIR}/print-failed-test-output print-failed-test-output
	...
	use cvs || sed -i '/^git-cvs/d' command-list.txt
