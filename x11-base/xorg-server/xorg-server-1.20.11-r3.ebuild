...
XORG_DOC=doc
inherit xorg-3 multilib flag-o-matic toolchain-funcs rhel-a
...
src_install() {
	...
	mkdir -p ${D}/etc/pam.d
	install -m 644 ${WORKDIR}/xserver.pamd ${D}/etc/pam.d/xserver

	mkdir -p ${D}/usr/share/X11/xorg.conf.d
	install -m 644 ${WORKDIR}/10-quirks.conf ${D}/usr/share/X11/xorg.conf.d
